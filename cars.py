...
dataset = TensorDataset('dataset/car_raw_imgs', 'dataset/car_masks', transform=training_transform)
...
if __name__ == "__main__":
    ...
    fcn_model = torch.load("models/cars-CrossEnt_batch2_epoch100_RMSprop_scheduler-step50-gamma0.5_lr0.0001_momentum0_w_decay1e-05")
    ...
    for idx, batch in enumerate(loader):
        ...
        with open('dataset/car_preds/prediction_' + str_idx + '.pred', 'wb') as handle:
